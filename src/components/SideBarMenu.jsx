    ...
    <div className=" bg-white bg-opacity-50 flex pt-5 h-auto sticky top-[75px]">
      <ul className="rounded-3xl overflow-hidden w-full px-1">
        ...
        <div className="relative">
          <div className="flex items-center justify-between hover:bg-black hover:text-white duration-200  w-full rounded-full cursor-pointer">
            <div className="flex items-center gap-3 w-[90%]">
              <Link to="/order" className="flex items-center gap-3 w-full p-3">
                <CiBoxes className="text-lg" />
                Order
              </Link>
            </div>
            <i onClick={toggleOrderMenu} className="pr-3">
              {orderMenuOpen ? <IoIosArrowUp /> : <IoIosArrowDown />}
            </i>
          </div>
          ...
          {orderMenuOpen && (
            <ul className="p-1 bg-gray-100 rounded-3xl space-y-12 text-sm">
              <Link to="/order/pending">
                <li className="hover:bg-black hover:text-white duration-200 p-2 pl-7 rounded-full">
                  Orders Items
                </li>
              </Link>
        ...
        <Link to="/salesperson">
          <li className="hover:bg-black hover:text-white duration-200 p-3 w-full rounded-full flex items-center gap-3">
            <LiaStreetViewSolid className="text-lg" />
            SalesPerson
          </li>
        </Link>
        <Link to="/attendance">
